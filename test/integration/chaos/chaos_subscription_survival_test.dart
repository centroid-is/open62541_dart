...
void main() {
  group(
    ...
    () {
      ...
      test(
        'monitored stream resumes fresh values after a transient latency window',
        () async {
          ...
          try {
            ...
            double? last;
            final errors = <Object>[];
            final mSub = dc.client.monitor(tempId, subId, samplingInterval: const Duration(milliseconds: 200)).listen((
              v,
            ) {
              count++;
              last = v.asDouble;
            ...
            await proxy.addLatency(
              ...
              jitter: const Duration(milliseconds: 150),
            );
